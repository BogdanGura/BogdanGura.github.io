...
let articleElement = document.getElementsByTagName("article");

for(let i = 0; i < reviews.length; i++) {
      let reviewCode = "";

      //Checking the type of the review 
      if(reviewType[i] === "P") {
      ...
      //Assigning review code to reviewCode variable
      ...
      articleElement[0].insertAdjacentHTML("beforeEnd", reviewCode)
}

//function that will generate stars on reviews
